...
import com.ssafy.model.UploadDateVO;

@Controller
public class UploadController {
	
	@RequestMapping("fileUpload.do")
	public ModelAndView fileUpload(HttpServletRequest request, HttpServletResponse response , UploadDateVO vo) throws Exception
	{
		//1. 업로드된 파일을 받아온다...
